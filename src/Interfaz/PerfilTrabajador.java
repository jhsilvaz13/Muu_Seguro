...
public class PerfilTrabajador extends javax.swing.JFrame {
    ...
    public PerfilTrabajador(Empresa emp, String nombreUsuario){
        empresa=emp;
        trabajador=empresa.darEmpleadoActual(nombreUsuario, empresa.darCodigo());
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabelAbreviacionUsuario.setText(trabajador.darNombre().charAt(0)+"");
        ...
        jLabelCirculoPerfil.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Interfaz/DataImage/circuloPerfilTra.png"))); // NOI18N
        jLabelCirculoPerfil.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        jLabelNombreUsuario.setText(trabajador.darNombre());
        ...
        jLabelFondoSup.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Interfaz/DataImage/FondoDos.png"))); // NOI18N
        ...
        jButtonVerContraseña.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Interfaz/DataImage/viewCafe.png"))); // NOI18N
        ...
        jTextFieldSalario.setText("$"+trabajador.darSalario());
        ...
        jTextFieldNombreDeUsuario.setText(trabajador.darNombre());
        ...
        jPasswordFieldContraseña.setText(trabajador.darContraseña());
        ...
        jToggleButtonModificar.setForeground(new java.awt.Color(128, 95, 29));
        ...
        jButtonRegresar.setBackground(new java.awt.Color(128, 95, 29));
        ...
        jTextFieldFecha.setText(trabajador.darFechaInicioLaboral());
    ...
    private void jToggleButtonModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButtonModificarActionPerformed
        ...
        if (jToggleButtonModificar.isSelected()) {
            ...
            jPasswordFieldContraseña.setBackground(new java.awt.Color(255, 234, 193));
        } else {
            jPasswordFieldContraseña.setEditable(false);
            jPasswordFieldContraseña.setBackground(new java.awt.Color(255, 255, 255));
        }
    ...
    private void jButtonRegresarMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonRegresarMouseEntered
        // TODO add your handling code here:
        jButtonRegresar.setBackground(new java.awt.Color(252,222,154));
    ...
    private void jButtonRegresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRegresarActionPerformed
        ...
        if (modificable) {
            ...
            if (respuesta != -1 && respuesta != 2) {
                if (respuesta == 0) {
                    empresa.darAdmin().modificarUsuario("Empleado", Integer.parseInt(jTextFieldSalario.getText().substring(1, jTextFieldSalario.getText().length())), jLabelNombreUsuario.getText(), jPasswordFieldContraseña.getText(), jTextFieldFecha.getText());
                    this.setVisible(false);
                    empresa = new Empresa(jTextFieldCodigoEmpresa.getText());
                    WorkerWindow ventana = new WorkerWindow(empresa,trabajador.darNombre());
